...
namespace ProjetoDeBloco.Dominio.Entidades.Instituicao.Pessoas
{
    public class Professor : Pessoa
    {
        ...
        public Professor(string nome, DateTime dataNascimento, string email,string areaDeFormacao, int anoDeFormacao)
        ...
        public void Editar(string nome, DateTime dataNascimento, string email,string areaDeFormacao, int anoDeFormacao)
        {
